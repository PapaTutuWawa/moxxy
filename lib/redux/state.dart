...
class MoxxyState {
  ...
  MoxxyState.initialState() : messages = HashMap(), conversations = List.empty(growable: true), loginPageState = LoginPageState(doingWork: false, showPassword: false), conversationPageState = ConversationPageState(showSendButton: false, showScrollToEndButton: false), addContactPageState = AddContactPageState(doingWork: false), registerPageState = RegisterPageState(providerIndex: -1, doingWork: false), postRegisterPageState = PostRegisterPageState(showSnackbar: false), profilePageState = ProfilePageState(showSnackbar: false), accountState = AccountState(jid: "", avatarUrl: "", displayName: "");
}
