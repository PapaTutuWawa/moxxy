...
class SquircleCachingXMPPAvatar extends StatefulWidget {
  const SquircleCachingXMPPAvatar({
    required this.jid,
    required this.size,
  ...
  @override
  SquircleCachingXMPPAvatarState createState() =>
      SquircleCachingXMPPAvatarState();
}

// TODO: Will replace CachingXMPPAvatar. When that time has some, remove "Squircle" from the name
class SquircleCachingXMPPAvatarState extends State<SquircleCachingXMPPAvatar> {
  ...
  @override
  void didUpdateWidget(SquircleCachingXMPPAvatar oldWidget) {
    super.didUpdateWidget(oldWidget);
