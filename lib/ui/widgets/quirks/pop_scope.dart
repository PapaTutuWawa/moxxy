...
@optionalTypeArgs
class PopScopeNotifier<T> extends StatefulWidget {
  ...
  const PopScopeNotifier({
    ...
    this.onPopInvoked,
  }) : assert(onPopInvokedWithResult == null || onPopInvoked == null,
  ...
  @override
  State<PopScopeNotifier<T>> createState() => _PopScopeNotifierState<T>();
}

class _PopScopeNotifierState<T> extends State<PopScopeNotifier<T>>
  ...
  @override
  ValueNotifier<bool> get canPopNotifier => widget.canPopNotifier;
