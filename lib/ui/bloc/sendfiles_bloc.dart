...
class SendFilesBloc extends Bloc<SendFilesEvent, SendFilesState> {
  ...
  Future<void> _sendFilesRequested(
      SendFilesPageRequestedEvent event, Emitter<SendFilesState> emit) async {
    List<String> files;
    if (event.paths != null) {
      files = event.paths!;
    } else {
  ...
  Future<void> _onIndexSet(
      IndexSetEvent event, Emitter<SendFilesState> emit) async {
    emit(state.copyWith(index: event.index));
  }

  Future<void> _onAddFilesRequested(
      AddFilesRequestedEvent event, Emitter<SendFilesState> emit) async {
  ...
  Future<void> _onFileSendingRequested(
      FileSendingRequestedEvent event, Emitter<SendFilesState> emitter) async {
  ...
  Future<void> _onItemRemoved(
      ItemRemovedEvent event, Emitter<SendFilesState> emit) async {
